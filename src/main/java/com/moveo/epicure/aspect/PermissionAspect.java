...
public class PermissionAspect {
    ...
    /**
     * Gets user type from token, checks if the method is in the type's permission list. If an exception is thrown in
     * the process of getting the token, getting the type's permission list and looking for the permit in the list or if
     * the permit is not found: throws NoPermitException Otherwise, run the method and returns the ResponseEntity it
     * generated/ throws the exception it threw.
     *
     * @param joinPoint
